...
├──────────────────────┼──────────────────────┼─────────────────────────┼──────────────────────┼─────────┼───────────────┤
│ **Antigravity IDE /**│ `Chrome_WidgetWin_1` │ **Open Editor Tabs**    │ `Class:tabs-container│ D7 – D8 │ **~10–15 ms** │
...
* **Micro-Spike 1:** Empirically verified C# FlaUI 5 tab extraction across Antigravity IDE (24 tabs @ 14.72 ms / 613 µs/tab) and Waterfox (30 tabs @ 13.30 ms / 443 µs/tab).
